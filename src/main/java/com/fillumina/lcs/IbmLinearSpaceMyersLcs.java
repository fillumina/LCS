 ...
 * @see <a href="http://grepcode.com/file/repo1.maven.org/maven2/org.docx4j/docx4j/2.8.0/org/eclipse/compare/rangedifferencer/RangeComparatorLCS.java#20">
 * org.eclipse.compare.rangedifference.RangeComparatorLCS
 * </a>
 */
public class IbmLinearSpaceMyersLcs<T> implements Lcs<T> {

    @Override
    public List<T> lcs(List<T> xs, List<T> ys) {
        return new IbmLcs<>(xs, ys).getSolution();
    }

    private static class IbmLcs<T> {

        private final List<T> a, b, solution = new ArrayList<>();
        ...
        private boolean isRangeEqual(int i1, int i2) {
            return a.get(i1).equals(b.get(i2));
        }

        private void setLcs(int sl1, int sl2) {
            solution.add(a.get(sl1));
        }
        ...
        /**
         * Myers' algorithm for longest common subsequence. O((M + N)D) worst
         ...
         * @param subMonitor
         */
        public IbmLcs(List<T> a, List<T> b) {
            this.a = a;
            this.b = b;
         ...
         * l1[bottoml1 .. topl1] and l2[bottoml2 .. topl2] fills in the
         * appropriate location in lcs and returns the length
         *
         ...
         * @param snake should be allocated as int[3], used to store the
         * beginning x, y coordinates and the length of the latest snake
         * traversed
         * @param subMonitor
         * @param lcs should be allocated as TextLine[2][l1.length], used to
         * store the common points found to be part of the LCS where lcs[0]
         ...
         * l1[bottoml1..topl1] and l2[bottoml2..topl2] The x, y coodrdinates of
         * the start of the middle snake are saved in snake[0], snake[1]
         * respectively and the length of the snake is saved in s[2].
         *
         * @param l1 The 1st sequence
         * @param bottoml1 Index in the 1st sequence to start from (inclusive)
         * @param topl1 Index in the 1st sequence to end on (inclusive)
         ...
         * used to store furthest reaching D-paths
         * @param snake should be allocated as int[3], used to store the
         * beginning x, y coordinates and the length of the middle snake
         *
         * @return The number of differences (SES) between l1[bottoml1..topl1]
         * and l2[bottoml2..topl2]
         */
        ...
        // System.out.println("N: " + N + " M: " + M + " bottom: " + bottoml1 +
            ...
            for (int d = 0; d <= limit; d++) {
                ...
                start_diag = Math.
                        max(value_to_add_backward + start_backward, -d);
        ...
        /**
         * Takes the array with furthest reaching D-paths from an LCS
         * computation and returns the x,y coordinates and progress made in the
         * middle diagonal among those with maximum progress, both from the
         ...
         * progress, result[1] is the y coordinate of the current location in
         * the diagonal with the most progress and result[2] is the amount of
         * progress made in that diagonal
         */
