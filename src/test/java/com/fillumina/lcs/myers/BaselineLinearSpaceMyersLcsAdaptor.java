...
import com.fillumina.lcs.myers.BaselineLinearSpaceMyersLcs.LcsItem;
 ...
 */
public class BaselineLinearSpaceMyersLcsAdaptor<T> implements Lcs<T> {
    ...
    private static class LinearSpaceMyersLcsImpl<T>
            extends BaselineLinearSpaceMyersLcs {
        private final T[] a, b;
